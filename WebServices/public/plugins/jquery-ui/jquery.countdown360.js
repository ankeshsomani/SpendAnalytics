...
;(function ($, window, document, undefined) {
  var pluginName = "countdown360",
    defaults = {
      ...
      strokeStyle: "#037EA6",     // the color of the stroke
      strokeWidth: 3.5,     // the stroke width, dynamically calulated if omitted in options
      fillStyle: "#FFFFFF",      // the fill color
      fontColor: "#FFFFFF",       // the font color
      fontFamily: "sans-serif",   // the font family
      fontSize: undefined,        // the font size, dynamically calulated if omitted in options
      fontWeight: 800,            // the font weight
