	 ...
	 if ((typeof cif !== "undefined") && (cif !== null)){
		if ((typeof year!== "undefined") && (year !== null)){
					if ((typeof month!== "undefined") && (month !== null)){
					 ...
					 validated=true;
					 query="select TO_CHAR((CAST(BCT.BSNS_DATE AS DATE)), 'dd-MMM-YYYY') as BSNS_DATE ,BCT.DESCRIPTION ,BCT.PAID_OUT AS EXPENSES,CAT.SUBCATEGORY AS TAGS from hdfs.tmp.vw_mongo_transactions BCT JOIN hdfs.tmp.vw_mongo_category CAT ON CAT.DESCRIPTION=BCT.DESCRIPTION JOIN hdfs.tmp.vw_mongo_days DAY1 on BCT.BSNS_DATE=DAY1.BSNS_DATE where BCT.cif ="+cif+" AND DAY1.MONTH_NO="+month+" AND DAY1.BSNS_YEAR="+year+" AND BCT.PAID_OUT>0 ";
